...
export default function AuthScreen({ 
  ...
  return (
    <div id="auth-screen-root" className="min-h-screen bg-[#F3FAF5] text-[#1E352E] flex flex-col items-center justify-center p-4 sm:p-6 font-sans antialiased">
      <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-stretch my-6">
        ...
        <div className="md:col-span-5 flex flex-col justify-between bg-[#123326] text-[#F4F8F5] rounded-[28px] p-6 sm:p-7 shadow-[0_24px_60px_rgba(18,51,38,0.16)] border border-[#143326] relative overflow-hidden">
          ...
          <div className="relative space-y-6">
            <div className="flex items-center gap-3">
              <div className="bg-[#D8F3DC] p-3 rounded-2xl text-[#163C2F] shadow-inner">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2 text-sm text-[#E5F5EB]">
                <div className="flex items-start gap-3 rounded-2xl bg-white/5 border border-white/10 p-3">
                  ...
                  <span><strong className="font-extrabold text-white">Sayon nga Pag-login:</strong> Pindota lang ang imong ngalan sa dapit sa ubos aron daling makasulod.</span>
                </div>
                <div className="flex items-start gap-3 rounded-2xl bg-white/5 border border-white/10 p-3">
                  <div className="bg-[#2D6A4F] p-1.5 rounded-full mt-0.5 text-white shrink-0">
                    <CheckCircle className="w-3.5 h-3.5" />
          ...
          <div className="relative mt-8 pt-4 border-t border-[#2D6A4F] flex items-center justify-between text-[11px] text-[#CBF0D6]">
            <span className="font-medium">Tuburan, Cebu Province</span>
            <span className="font-bold flex items-center gap-1 bg-[#295A43] px-2.5 py-1.5 rounded-full border border-[#357256]">
        ...
        <div className="md:col-span-7 bg-white rounded-[28px] p-5 sm:p-7 shadow-[0_24px_60px_rgba(19,39,31,0.10)] border-2 border-[#E3F0E5] flex flex-col justify-between">
          
          {/* Form Header Tabs */}
          <div className="space-y-6">
            <div className="flex justify-between items-center border-b border-[#EAF0EA] pb-3">
                ...
                <button
                  ...
                  className={`text-sm font-extrabold font-display pb-3 relative transition-all cursor-pointer tracking-[0.08em] ${
                    isLogin && !showResetForm
                      ? 'text-[#123326] border-b-2 border-[#123326]'
            ...
            {showResetForm ? (
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="space-y-2">
                  <span className="flex items-center gap-1 text-xs font-extrabold text-[#4F5E46] uppercase tracking-wider">
                ...
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-[10px] text-[#6E7F73] italic">Sulata imong alyas</span>
                    </div>
                    <div className="relative">
