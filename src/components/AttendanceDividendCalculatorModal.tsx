      ...
      <html>
        ...
        <body>
          ...
          <div class="formula-note">
            <strong>BUDGET & CAPITAL ORIGIN (WHERE BUDGET WAS TAKEN FROM):</strong> Revolving Livelihood Capital funded by the <strong>Association Livelihood & Livestock Project Fund</strong>. 
            <br/><br/>
